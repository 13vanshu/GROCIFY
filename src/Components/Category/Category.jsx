          ...
          {category.map((cards) => (
            ...
            >
              ...
              <div className="bg-linear-to-b from-white to-zinc-200 p-6 sm:p-7 md:p-8 pt-14 sm:pt-16 md:pt-17 rounded-xl">
                ...
                <Link to={cards.path} className=' bg-linear-to-b from-orange-400 to-orange-500 text-white px-8 py-3 items-center rounded-lg md:text-lg text-md hover:scale-105 hover:to-orange-600 transition-all duration-300 cursor-pointer '>
                  See All
                </Link>
              </div>
            </div>
